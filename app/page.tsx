...
const PROBLEMS = [
  ...
  { key: 'cash', label: '不知道赚没赚', icon: WalletCards, tool: 'CashRadar PRO 预览', note: '先看回款系统如何统一管理应收、流水、逾期和经营指标。', href: 'https://chenxiaolong-maxgent.github.io/offerflow/#cashradar', action: '查看功能与预览', paid: '回款管理表', price: '¥29', paidHref: 'https://github.com/chenxiaolong-maxgent/offerflow/issues/2' },
  { key: 'system', label: '想一套全部搞定', icon: Blocks, tool: 'SoloStack 全部目录', note: '先比较免费工具、成品模板和产品化服务，再按当前阶段选择。', href: '#catalog', action: '浏览全部工具', paid: '接单经营全家桶', price: '¥69', paidHref: 'https://github.com/chenxiaolong-maxgent/freelance-ops-kit/issues/1' },
] as const;
...
const CATALOG: CatalogItem[] = [
  ...
  { name: '接单经营全家桶', type: 'product' as const, price: '¥69', description: '9 份 Word 模板、Excel 回款系统与成交回款工作流。', href: 'https://github.com/chenxiaolong-maxgent/freelance-ops-kit/issues/1', icon: PackageCheck, featured: true },
